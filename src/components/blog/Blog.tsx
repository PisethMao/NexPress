    ...
    return (
        <section className="min-h-screen relative overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900">
            ...
            <div className="relative z-10 w-[95%] md:w-[85%] mx-auto px-4 sm:px-6 lg:px-8 py-40">
                        ...
                        <button
                            ...
                            className={`flex-1 py-4 sm:py-5 px-6 sm:px-8 rounded-xl sm:rounded-2xl font-bold transition-all duration-300 flex items-center justify-center gap-3 text-base sm:text-lg relative overflow-hidden group ${
                                activeTab === tab
                                    ...
                                    : "text-gray-700 dark:text-white/70 hover:bg-white/50 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white/90 border border-transparent hover:border-white/30 dark:hover:border-white/10"
                            }`}
                        >
                            {activeTab === tab && (
                ...
                <div className="backdrop-blur-xl bg-white/30 dark:bg-white/5 rounded-2xl p-4 mb-8 border border-white/40 dark:border-white/20 shadow-xl">
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div className="text-center">
                            ...
                            <div className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400 bg-clip-text text-transparent capitalize">
                                {activeTab}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-center min-h-[600px]">
                        <div className="backdrop-blur-2xl bg-gradient-to-br from-white/50 to-white/30 dark:from-white/10 dark:to-white/5 rounded-3xl p-16 border border-white/40 dark:border-white/20 shadow-2xl">
                            <div className="relative">
                                <Loader2 className="w-16 h-16 mx-auto text-purple-600 dark:text-white animate-spin" />
                ...
                {selectedBlog && (
                    ...
                    >
                        <div
                            className="backdrop-blur-2xl bg-gradient-to-br from-white/90 to-white/70 dark:from-white/10 dark:to-white/5 rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-10 border border-white/60 dark:border-white/20 w-[80%] md:w-[65%] max-h-[85vh] mt-30 overflow-y-auto shadow-2xl animate-in slide-in-from-bottom-8 duration-500 scrollbar-thin scrollbar-thumb-gray-400 dark:scrollbar-thumb-white/20 scrollbar-track-transparent"
