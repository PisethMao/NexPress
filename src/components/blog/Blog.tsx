...
const BlogManagement = () => {
  ...
  const renderBlogCard = (blog: Blog) => (
    <div
      ...
      className="group relative backdrop-blur-xl bg-linear-to-br from-white/8 to-white/5 dark:from-white/8 dark:to-white/5 rounded-3xl p-6 sm:p-8 border border-white/20 dark:border-white/20 hover:border-white/30 dark:hover:border-white/30 transition-all duration-500 cursor-pointer hover:-translate-y-2 hover:shadow-[0_25px_70px_-15px_rgba(255,255,255,0.15)] dark:hover:shadow-[0_25px_70px_-15px_rgba(255,255,255,0.15)] overflow-hidden"
    >
      {/* Animated gradient overlay */}
      <div className="absolute inset-0 bg-linear-to-br from-blue-500/0 via-purple-500/0 to-pink-500/0 group-hover:from-blue-500/5 group-hover:via-purple-500/5 group-hover:to-pink-500/5 rounded-3xl transition-all duration-700" />
      ...
      <div className="relative z-10">
        <div className="flex items-start justify-between mb-5 sm:mb-6">
          <div className="p-3 sm:p-3.5 backdrop-blur-xl bg-linear-to-br from-white/15 to-white/5 dark:from-white/15 dark:to-white/5 rounded-2xl border border-white/20 dark:border-white/20 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg">
            {getIcon(activeTab)}
          </div>
          {blog.tags && (
            <span className="text-xs sm:text-sm px-3 sm:px-4 py-1.5 sm:py-2 backdrop-blur-xl bg-linear-to-r from-white/15 to-white/10 dark:from-white/15 dark:to-white/10 rounded-full border border-white/20 dark:border-white/20 text-gray-900 dark:text-white font-medium shadow-lg">
              {blog.tags[0]}
            </span>
          )}
        </div>
  ...
  return (
    <section className="min-h-screen relative overflow-hidden bg-linear-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900 py-35">
      {/* Enhanced Background Gradient */}
      <div className="absolute inset-0 bg-linear-to-br from-blue-400/20 via-purple-400/20 to-pink-400/20 dark:from-blue-600/30 dark:via-purple-600/30 dark:to-pink-600/30 blur-3xl" />
      ...
      <div
        className="absolute bottom-0 right-1/4 w-96 h-96 bg-purple-300/30 dark:bg-purple-500/20 rounded-full blur-3xl animate-pulse"
        style={{ animationDelay: "1s" }}
      />

      <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        {/* Header */}
        <div className="backdrop-blur-2xl bg-linear-to-br from-white/60 to-white/40 dark:from-white/10 dark:to-white/5 rounded-3xl sm:rounded-[2.5rem] p-8 sm:p-10 lg:p-12 mb-8 sm:mb-10 lg:mb-12 border border-white/40 dark:border-white/20 shadow-2xl">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-5 mb-3">
            <div className="p-3.5 sm:p-4 backdrop-blur-xl bg-linear-to-br from-white/40 to-white/20 dark:from-white/20 dark:to-white/10 rounded-2xl border border-white/50 dark:border-white/30 shadow-xl">
          ...
          <p className="text-gray-700 dark:text-white/80 text-base sm:text-lg lg:text-xl sm:ml-18 lg:ml-22 font-light">
          ...
          {Object.keys(endpoints).map((tab) => (
            <button
              ...
              className={`flex-1 py-4 sm:py-5 px-6 sm:px-8 rounded-xl sm:rounded-2xl font-bold transition-all duration-300 flex items-center justify-center gap-3 text-base sm:text-lg relative overflow-hidden group ${
                activeTab === tab
                  ? "bg-linear-to-r from-white/50 to-white/30 dark:from-white/20 dark:to-white/10 text-gray-900 dark:text-white shadow-xl border border-white/50 dark:border-white/30 scale-[1.02]"
            ...
            >
              {activeTab === tab && (
                <div className="absolute inset-0 bg-linear-to-r from-blue-400/10 to-purple-400/10 dark:from-blue-500/10 dark:to-purple-500/10 animate-pulse" />
              )}
        ...
        {loading ? (
          <div className="flex items-center justify-center min-h-[600px]">
            <div className="backdrop-blur-2xl bg-linear-to-br from-white/50 to-white/30 dark:from-white/10 dark:to-white/5 rounded-3xl p-16 border border-white/40 dark:border-white/20 shadow-2xl">
              <div className="relative">
                <Loader2 className="w-16 h-16 text-purple-600 dark:text-white animate-spin" />
                <div className="absolute inset-0 rounded-full bg-linear-to-tr from-blue-400/30 to-purple-400/30 dark:from-blue-500/30 dark:to-purple-500/30 blur-2xl animate-pulse"></div>
              </div>
              <p className="text-gray-800 dark:text-white/80 text-lg mt-6 font-medium">
                Loading {activeTab}...
              </p>
            </div>
          </div>
          ...
          <>
            ...
            {/* Pagination */}
            <div className="backdrop-blur-xl bg-linear-to-r from-white/40 to-white/30 dark:from-white/10 dark:to-white/5 rounded-2xl sm:rounded-3xl p-5 sm:p-7 border border-white/40 dark:border-white/20 flex flex-col sm:flex-row items-center justify-between gap-5 shadow-xl">
              <button
                type="button"
                onClick={() => changePage("prev")}
                disabled={currentPage === 1}
                className="w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-4 rounded-xl sm:rounded-2xl backdrop-blur-xl bg-linear-to-r from-white/40 to-white/30 dark:from-white/15 dark:to-white/10 text-gray-900 dark:text-white font-bold disabled:opacity-30 disabled:cursor-not-allowed hover:from-white/50 hover:to-white/40 dark:hover:from-white/20 dark:hover:to-white/15 hover:scale-105 active:scale-95 transition-all duration-300 border border-white/50 dark:border-white/20 shadow-lg disabled:hover:scale-100"
              >
              ...
              <div className="flex items-center gap-3 backdrop-blur-xl bg-white/30 dark:bg-white/10 px-6 py-3 rounded-2xl border border-white/40 dark:border-white/20">
                ...
                <span className="text-gray-600 dark:text-white/50 text-base sm:text-lg">
                  of
                </span>
        ...
        {selectedBlog && (
          ...
          >
            <div
              className="backdrop-blur-2xl bg-linear-to-br from-white/90 to-white/70 dark:from-white/10 dark:to-white/5 rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-10 border border-white/60 dark:border-white/20 max-w-5xl w-full max-h-[70vh] overflow-y-auto shadow-2xl animate-in slide-in-from-bottom-8 duration-500 scrollbar-thin scrollbar-thumb-gray-400 dark:scrollbar-thumb-white/20 scrollbar-track-transparent"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-8">
                <div className="flex items-center gap-4 flex-1 pr-4">
                  <div className="p-4 backdrop-blur-xl bg-linear-to-br from-white/60 to-white/40 dark:from-white/20 dark:to-white/10 rounded-2xl border border-white/60 dark:border-white/30 shrink-0 shadow-xl">
                    {getIcon(activeTab)}
                  </div>
              ...
              <div className="space-y-6 sm:space-y-8">
                {activeTab === "quotes" && (
                  <div className="backdrop-blur-xl bg-linear-to-br from-white/70 to-white/50 dark:from-white/10 dark:to-white/5 rounded-2xl sm:rounded-3xl p-8 sm:p-10 border border-white/60 dark:border-white/20 shadow-xl">
                    ...
                    <div className="flex items-center gap-4 pt-6 border-t border-gray-300 dark:border-white/20">
                      <div className="w-12 h-12 rounded-full bg-linear-to-br from-blue-400/50 to-purple-400/50 dark:from-blue-500/40 dark:to-purple-500/40 flex items-center justify-center text-gray-900 dark:text-white font-bold text-lg border-2 border-white/40 dark:border-white/20 shadow-lg">
                    ...
                    {selectedBlog.tags && selectedBlog.tags.length > 0 && (
                      <div className="flex gap-2 flex-wrap mb-6 pb-6 border-b border-gray-300 dark:border-white/20">
                        {selectedBlog.tags.map((tag, i) => (
                          <span
                            key={i}
                            className="px-4 py-2 backdrop-blur-xl bg-linear-to-r from-white/50 to-white/40 dark:from-white/15 dark:to-white/10 rounded-xl text-sm text-gray-900 dark:text-white font-medium border border-white/60 dark:border-white/20 shadow-lg hover:scale-105 transition-transform cursor-default"
                          >
                            #{tag}
                          </span>
                        ))}
                ...
                {activeTab === "recipes" && (
                  <div className="space-y-6">
                    <div className="backdrop-blur-xl bg-linear-to-br from-white/70 to-white/50 dark:from-white/10 dark:to-white/5 rounded-2xl sm:rounded-3xl overflow-hidden border border-white/60 dark:border-white/20 shadow-xl">
                      ...
                      {comments.map((comment) => (
                        ...
                        >
                          <div className="flex items-center gap-3 mb-3">
                            <div className="w-10 h-10 bg-linear-to-br from-blue-400/60 to-purple-400/60 dark:from-blue-500/40 dark:to-purple-500/40 rounded-full flex items-center justify-center text-gray-900 dark:text-white font-bold text-sm border-2 border-white/50 dark:border-white/20 group-hover:scale-110 transition-transform">
                          ...
                          <p className="text-base text-gray-800 dark:text-white/80 leading-relaxed pl-13">
                            {comment.body}
                          </p>
                        </div>
                      ))}
